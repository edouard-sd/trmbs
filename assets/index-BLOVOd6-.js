 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ec=Math.log(2);class Cc{constructor(e){const t=r=>parseInt(Math.log(r)/Ec,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const $t=function(n,e,t,s){n.sort(e);const i=function(l,c){const u=c-l;let h,d;if(u===0)return null;if(u===1)return h=n[l],d=t?t(h):h,new D(d,h.node,D.BLACK,null,null);{const p=parseInt(u/2,10)+l,m=i(l,p),C=i(p+1,c);return h=n[p],d=t?t(h):h,new D(d,h.node,D.BLACK,m,C)}},r=function(l){let c=null,u=null,h=n.length;const d=function(m,C){const R=h-m,se=h;h-=m;const ie=i(R+1,se),ye=n[R],fn=t?t(ye):ye;p(new D(fn,ye.node,C,null,ie))},p=function(m){c?(c.left=m,c=m):(u=m,c=m)};for(let m=0;m<l.count;++m){const C=l.nextBitIsOne(),R=Math.pow(2,l.count-(m+1));C?d(R,D.BLACK):(d(R,D.BLACK),d(R,D.RED))}return u},o=new Cc(n.length),a=r(o);return new z(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sd(n){return{filter:n}}function id(n,e){f(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),f(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function rd(n,e,t,s,i){const r=new td;let o,a;if(t.type===X.OVERWRITE){const c=t;c.source.fromUser?o=$n(n,e,c.path,c.snap,s,i,r):(f(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!v(c.path),o=jt(n,e,c.path,c.snap,s,i,a,r))}else if(t.type===X.MERGE){const c=t;c.source.fromUser?o=ad(n,e,c.path,c.children,s,i,r):(f(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Bn(n,e,c.path,c.children,s,i,a,r))}else if(t.type===X.ACK_USER_WRITE){const c=t;c.revert?o=dd(n,e,c.path,s,i,r):o=ld(n,e,c.path,c.affectedTree,s,i,r)}else if(t.type===X.LISTEN_COMPLETE)o=cd(n,e,t.path,s,r);else throw He("Unknown operation type: "+t.type);const l=r.getChanges();return od(e,o,l),{viewCache:o,changes:l}}function od(n,e,t){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=Ut(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&t.push(Dr(Ut(e)))}}function Vr(n,e,t,s,i,r){const o=e.eventCache;if(zt(s,t)!=null)return e;{let a,l;if(v(t))if(f(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Re(e),u=c instanceof _?c:_.EMPTY_NODE,h=ls(s,u);a=n.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=Vt(s,Re(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=g(t);if(c===".priority"){f(_e(t)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const h=yi(s,t,u,l);h!=null?a=n.filter.updatePriority(u,h):a=o.getNode()}else{const u=T(t);let h;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const d=yi(s,t,o.getNode(),l);d!=null?h=o.getNode().getImmediateChild(c).updateChild(u,d):h=o.getNode().getImmediateChild(c)}else h=cs(s,c,e.serverCache);h!=null?a=n.filter.updateChild(o.getNode(),c,h,u,i,r):a=o.getNode()}}return et(e,a,o.isFullyInitialized()||v(t),n.filter.filtersNodes())}}function jt(n,e,t,s,i,r,o,a){const l=e.serverCache;let c;const u=o?n.filter:n.filter.getIndexedFilter();if(v(t))c=u.updateFullNode(l.getNode(),s,null);else if(u.filtersNodes()&&!l.isFiltered()){const p=l.getNode().updateChild(t,s);c=u.updateFullNode(l.getNode(),p,null)}else{const p=g(t);if(!l.isCompleteForPath(t)&&_e(t)>1)return e;const m=T(t),R=l.getNode().getImmediateChild(p).updateChild(m,s);p===".priority"?c=u.updatePriority(l.getNode(),R):c=u.updateChild(l.getNode(),p,R,m,Ur,null)}const h=Or(e,c,l.isFullyInitialized()||v(t),u.filtersNodes()),d=new ds(i,h,r);return Vr(n,h,t,i,d,a)}function $n(n,e,t,s,i,r,o){const a=e.eventCache;let l,c;const u=new ds(i,e,r);if(v(t))c=n.filter.updateFullNode(e.eventCache.getNode(),s,o),l=et(e,c,!0,n.filter.filtersNodes());else{const h=g(t);if(h===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),s),l=et(e,c,a.isFullyInitialized(),a.isFiltered());else{const d=T(t),p=a.getNode().getImmediateChild(h);let m;if(v(d))m=s;else{const C=u.getCompleteChild(h);C!=null?wr(d)===".priority"&&C.getChild(Sr(d)).isEmpty()?m=C:m=C.updateChild(d,s):m=_.EMPTY_NODE}if(p.equals(m))l=e;else{const C=n.filter.updateChild(a.getNode(),h,m,d,u,o);l=et(e,C,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function bi(n,e){return n.eventCache.isCompleteForChild(e)}function ad(n,e,t,s,i,r,o){let a=e;return s.foreach((l,c)=>{const u=A(t,l);bi(e,g(u))&&(a=$n(n,a,u,c,i,r,o))}),s.foreach((l,c)=>{const u=A(t,l);bi(e,g(u))||(a=$n(n,a,u,c,i,r,o))}),a}function Ei(n,e,t){return t.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function Bn(n,e,t,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;v(t)?c=s:c=new N(null).setTree(t,s);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const p=e.serverCache.getNode().getImmediateChild(h),m=Ei(n,p,d);l=jt(n,l,new I(h),m,i,r,o,a)}}),c.children.inorderTraversal((h,d)=>{const p=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!p){const m=e.serverCache.getNode().getImmediateChild(h),C=Ei(n,m,d);l=jt(n,l,new I(h),C,i,r,o,a)}}),l}function ld(n,e,t,s,i,r,o){if(zt(i,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(s.value!=null){if(v(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return jt(n,e,t,l.getNode().getChild(t),i,r,a,o);if(v(t)){let c=new N(null);return l.getNode().forEachChild(Te,(u,h)=>{c=c.set(new I(u),h)}),Bn(n,e,t,c,i,r,a,o)}else return e}else{let c=new N(null);return s.foreach((u,h)=>{const d=A(t,u);l.isCompleteForPath(d)&&(c=c.set(u,l.getNode().getChild(d)))}),Bn(n,e,t,c,i,r,a,o)}}function cd(n,e,t,s,i){const r=e.serverCache,o=Or(e,r.getNode(),r.isFullyInitialized()||v(t),r.isFiltered());return Vr(n,o,t,s,Ur,i)}function dd(n,e,t,s,i,r){let o;if(zt(s,t)!=null)return e;{const a=new ds(s,e,i),l=e.eventCache.getNode();let c;if(v(t)||g(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Vt(s,Re(e));else{const h=e.serverCache.getNode();f(h instanceof _,"serverChildren would be complete if leaf node"),u=ls(s,h)}u=u,c=n.filter.updateFullNode(l,u,r)}else{const u=g(t);let h=cs(s,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=l.getImmediateChild(u)),h!=null?c=n.filter.updateChild(l,u,h,T(t),a,r):e.eventCache.getNode().hasChild(u)?c=n.filter.updateChild(l,u,_.EMPTY_NODE,T(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Vt(s,Re(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||zt(s,E())!=null,et(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Au(n){vl(il),Mt(new it("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Su(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Me(Xs,Js,n),Me(Xs,Js,"esm2017")}oe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};oe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Au();const Pi={apiKey:"AIzaSyCdjqi9HWTze561v2HAu_s3orKXVhC3tdA",authDomain:"trombinoscope-87ae6.firebaseapp.com",databaseURL:"https://trombinoscope-87ae6-default-rtdb.europe-west1.firebasedatabase.app",projectId:"trombinoscope-87ae6",storageBucket:"trombinoscope-87ae6.firebasestorage.app",messagingSenderId:"872375555849",appId:"1:872375555849:web:3d21c50733c79fae0c25d8",measurementId:"G-9GRF3XVRPB"};let Di=null,ln=null,wt=!1;function Pu(){try{return Pi.apiKey==="REMPLACE-MOI"?(console.warn("⚠️ Firebase n'est pas configuré. Le leaderboard sera en mode hors-ligne."),!1):(Di=Xi(Pi),ln=Ru(Di),wt=!0,console.log("✅ Firebase initialisé avec succès"),!0)}catch(n){return console.error("❌ Erreur Firebase :",n),!1}}function Li(){return wt}async function cn(n,e,t="general"){if(!wt){Mi(n,e,t);return}try{const s=Ns(ln,`leaderboard/${n}`),i=await go(s);if(i.exists()){const r=i.val();await Ai(s,{pseudo:n,score:(r.score||0)+e,gamesPlayed:(r.gamesPlayed||0)+1,bestScore:Math.max(r.bestScore||0,e),lastPlayed:new Date().toISOString(),lastMode:t})}else await Ai(s,{pseudo:n,score:e,gamesPlayed:1,bestScore:e,lastPlayed:new Date().toISOString(),lastMode:t})}catch(s){console.error("❌ Erreur sauvegarde score :",s),Mi(n,e,t)}}async function Du(n=50){if(!wt)return zn();try{const e=Ns(ln,"leaderboard"),t=Eo(e,bo("score"),yo(n)),s=await go(t);if(!s.exists())return[];const i=[];return s.forEach(r=>{i.push({id:r.key,...r.val()})}),i.sort((r,o)=>o.score-r.score)}catch(e){return console.error("❌ Erreur récupération leaderboard :",e),zn()}}function Lu(n){if(!wt)return n(zn()),()=>{};const e=Ns(ln,"leaderboard"),t=Eo(e,bo("score"),yo(50));return yu(t,i=>{if(!i.exists()){n([]);return}const r=[];i.forEach(o=>{r.push({id:o.key,...o.val()})}),n(r.sort((o,a)=>a.score-o.score))})}function Mi(n,e,t){const s=JSON.parse(localStorage.getItem("leaderboard")||"{}");s[n]?(s[n].score=(s[n].score||0)+e,s[n].gamesPlayed=(s[n].gamesPlayed||0)+1,s[n].bestScore=Math.max(s[n].bestScore||0,e),s[n].lastPlayed=new Date().toISOString(),s[n].lastMode=t):s[n]={pseudo:n,score:e,gamesPlayed:1,bestScore:e,lastPlayed:new Date().toISOString(),lastMode:t},localStorage.setItem("leaderboard",JSON.stringify(s))}function zn(){const n=JSON.parse(localStorage.getItem("leaderboard")||"{}");return Object.values(n).sort((e,t)=>t.score-e.score)}const Mu="LucasBode67";function Ou(n){n.innerHTML=`
  ...
  `,de(()=>{G="fiches",Z(n,e)}),document.getElementById("tab-fiches").addEventListener("click",()=>{G="fiches",Z(n,e)}),o.forEach((l,c)=>{document.getElementById(`option-${c}`).addEventListener("click",()=>{const u=i.id||i.photo,d=(l.id||l.photo)===u,{points:p}=As(F,d);document.querySelectorAll(".option-card").forEach(m=>{m.classList.add("disabled"),m.dataset.id===u&&m.classList.add("correct")}),d?We(`✅ +${p} points !`,"success"):(document.getElementById(`option-${c}`).classList.add("wrong"),We("❌ Raté !","error")),setTimeout(()=>{ks(F),Os(n,e,t,s)},1500)})})}async function Yu(n,e,t,s){const i=je();await cn(i,F.score,`review-${V}`),n.innerHTML=un(F),document.getElementById("btn-replay").addEventListener("click",()=>{F=Pe(t,Math.min(10,t.length)),Os(n,e,t,s)}),document.getElementById("btn-back-menu").addEventListener("click",()=>{H=null,V=null,M("menu")})}const Rt=[{key:"firstName",label:"Prénom ?"},{key:"lastName",label:"Nom de famille ?"},{key:"list",label:"Liste BDE ?"},{key:"poleName",label:"Dans quel Pôle ?"},{key:"role",label:"Rôle principal ?"},{key:"roleTransverse",label:"Rôle transverse ?"}];let Io=[],So=[],To=[],kt=[];function Ku(n){Io=[...new Set(n.map(e=>e.list))].filter(Boolean),So=[...new Set(n.map(e=>e.poleName||e.pole))].filter(Boolean),To=[...new Set(n.map(e=>e.role))].filter(Boolean),kt=[...new Set(n.map(e=>e.roleTransverse))].filter(Boolean),kt.includes("Aucun (❌)")||kt.push("Aucun (❌)")}function Xu(n,e,t){const s=Rt[n];let i=e[s.key];s.key==="poleName"&&(i=e.poleName||e.pole),s.key==="roleTransverse"&&!i&&(i="Aucun (❌)");let r=[];s.key==="firstName"?r=[...new Set(t.map(u=>u.firstName))]:s.key==="lastName"?r=[...new Set(t.map(u=>u.lastName))]:s.key==="list"?r=Io:s.key==="poleName"?r=So:s.key==="role"?r=To:s.key==="roleTransverse"&&(r=kt);const o=String(i||"");r=r.filter(u=>String(u||"")!==o&&u);let l=pt(r).slice(0,3);for(;l.length<3&&r.length>0;)l.push(r[Math.floor(Math.random()*r.length)]);return{options:pt([o,...l]),correctAnswer:o}}let Q=0,Ke=0,b=null;function No(n,e){const t=dn(e);if(Ku(t),t.length<4){n.innerHTML=`
      ${ne("Trouve les infos","")}
  ...
  `,de(s),o.forEach((l,c)=>{const u=document.getElementById(`option-${c}`);u.addEventListener("click",()=>{n.querySelectorAll(".option-card").forEach(d=>{d.style.pointerEvents="none",d.dataset.val===a?d.classList.add("correct"):d===u?d.classList.add("wrong"):d.style.opacity="0.5"}),l!==a&&Ke++,setTimeout(()=>{Q++,Q>=Rt.length&&(Ke===0?(b.score+=b.scoreMultiplier||100,b.correct=(b.correct||0)+1,b.streak=(b.streak||0)+1,b.bestStreak=Math.max(b.bestStreak||0,b.streak)):(b.wrong=(b.wrong||0)+1,b.streak=0),b.answers=b.answers||[],b.answers.push({correctPerson:i,isCorrect:Ke===0,timeTaken:Date.now()-b.startTime}),b.currentIndex++,Q=0,b.startTimerObj=!1),xo(n,e,t,s)},1e3)})})}let Nt=null;async function Ju(n){const e=je();if(n.innerHTML=`
    ${ne("Classement","")}
